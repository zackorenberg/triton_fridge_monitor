...
if sys.platform == 'win32':
    import ctypes
    ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID('triton.monitor.app.1')
import logger
...
class MainApplication(QtWidgets.QMainWindow):
    ...
    def __init__(self, log_path=localvars.LOG_PATH):
        ...
        self.setWindowTitle("Triton Fridge Monitor")
        if localvars.DEBUG_MODE:
            self.setWindowTitle("Triton Fridge Monitor (DEBUG)")
