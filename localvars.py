...
CONFIG_OPTIONAL_FIELDS = ['COOLERSYSLOG_PATH','CHANNEL_BLACKLIST', 'VERBOSE', 'DEBUG_MODE', 'KEEP_LOGFILES_OPEN', 'COOLERSYSLOG_CASE_SENSITIVE', 'MAX_CHANNELS_COUNT']

CONFIGTYPE_FIELDS_DIRECTORY = ['LOG_PATH', 'COOLERSYSLOG_PATH']
...
COOLERSYSLOG_CASE_SENSITIVE = True
COOLERSYSLOG_MAX_LINES_IN_READER = 400
